...
class mmm_cla_admin_menu_items 
{
	...
	// ---------------------------------------------------------------------------------------------------------------------
		...
		static function add_admin_menu_items ()
		{
			...
			wp_localize_script( MMM_CLA_PLUGIN_ID_LONG_MINUS.'-admin-scripts-header', 'translated_for_js', $translated_for_js );
			wp_localize_script( MMM_CLA_PLUGIN_ID_LONG_MINUS.'-admin-scripts-footer', 'translated_for_js', $translated_for_js );
		}
}